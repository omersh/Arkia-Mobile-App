...
function GeneralService_GetOracleSession(params, headers){
	var soapEnvNS = '';
    ...
    var mappings = {
		roots: {
			'GetOracleSession': { nsPrefix: 'tns', type: 'tns:GetOracleSession' }				
		},
		
		types: {
		}
	};
    var namespaces = 'xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://tempuri.org/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" ';
    var request = buildBody(params, namespaces, mappings, soapEnvNS);
    var soapAction = 'http://tempuri.org/GetOracleSession';
