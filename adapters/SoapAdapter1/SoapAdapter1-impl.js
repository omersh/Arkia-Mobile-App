...
function DomesticFlightsService_GetLocations(params, headers){
	var soapEnvNS = '';
    ...
    var mappings = {
		roots: {
			'GetLocations': { nsPrefix: 'tns', type: 'tns:GetLocations' }				
		},
    ...
    var soapAction = 'http://tempuri.org/GetLocations';
    return invokeWebService(request, headers, soapAction);
}


function DomesticFlightsService_GetDeptPaths(params, headers){
	var soapEnvNS = '';
    // The value of 'soapEnvNS' was set based on the version of the SOAP to be used (i.e. 1.1 or 1.2).
    soapEnvNS = 'http://schemas.xmlsoap.org/soap/envelope/';
    ...
    var mappings = {
		roots: {
			'GetDeptPaths': { nsPrefix: 'tns', type: 'tns:GetDeptPaths' }				
		},
    ...
    var namespaces = 'xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:tns="http://tempuri.org/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" ';
    var request = buildBody(params, namespaces, mappings, soapEnvNS);
    var soapAction = 'http://tempuri.org/GetDeptPaths';
    return invokeWebService(request, headers, soapAction);
}


function DomesticFlightsService_GetCloseProduct(params, headers){
	var soapEnvNS = '';
    // The value of 'soapEnvNS' was set based on the version of the SOAP to be used (i.e. 1.1 or 1.2).
    soapEnvNS = 'http://schemas.xmlsoap.org/soap/envelope/';
    ...
    var mappings = {
		roots: {
			'GetCloseProduct': { nsPrefix: 'tns', type: 'tns:GetCloseProduct' }				
		},
		
		types: {
			'tns:GetCloseProduct': {
				children: {
					'oracleSession': { nsPrefix: 'tns' },	
					'obFlsn': { nsPrefix: 'tns' },	
					'ibFlsn': { nsPrefix: 'tns' },	
					'pkgsn': { nsPrefix: 'tns' },	
					'tourOperatorSn': { nsPrefix: 'tns' },	
					'obRoutesn': { nsPrefix: 'tns' },	
					'ibRoutesn': { nsPrefix: 'tns' }	
				}
			}
		}
	};
    var namespaces = 'xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:tns="http://tempuri.org/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" ';
    var request = buildBody(params, namespaces, mappings, soapEnvNS);
    var soapAction = 'http://tempuri.org/GetCloseProduct';
    return invokeWebService(request, headers, soapAction);
}


function DomesticFlightsService_GetSearchResults(params, headers){
	var soapEnvNS = '';
    // The value of 'soapEnvNS' was set based on the version of the SOAP to be used (i.e. 1.1 or 1.2).
    ...
    var mappings = {
		roots: {
			'GetSearchResults': { nsPrefix: 'tns', type: 'tns:GetSearchResults' }				
		},
		...
		types: {
			'tns:GetSearchResults': {
				children: {
					'oracleSession': { nsPrefix: 'tns' },	
					'minDateTime': { nsPrefix: 'tns' },	
					'arrCityCode': { nsPrefix: 'tns' },	
					'depStationCode': { nsPrefix: 'tns' },	
					'arrStationCode': { nsPrefix: 'tns' },	
					'cacheVariant': { nsPrefix: 'tns' },	
					'searchDate': { nsPrefix: 'tns' },	
					'depCityCode': { nsPrefix: 'tns' }	
				}
			}
		}
	};
    var namespaces = 'xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:tns="http://tempuri.org/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" ';
    var request = buildBody(params, namespaces, mappings, soapEnvNS);
    var soapAction = 'http://tempuri.org/GetSearchResults';
    return invokeWebService(request, headers, soapAction);
}


function DomesticFlightsService_GetArrvPaths(params, headers){
	var soapEnvNS = '';
    // The value of 'soapEnvNS' was set based on the version of the SOAP to be used (i.e. 1.1 or 1.2).
    soapEnvNS = 'http://schemas.xmlsoap.org/soap/envelope/';
    ...
    var mappings = {
		roots: {
			'GetArrvPaths': { nsPrefix: 'tns', type: 'tns:GetArrvPaths' }				
		},
    ...
    var namespaces = 'xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:tns="http://tempuri.org/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" ';
    var request = buildBody(params, namespaces, mappings, soapEnvNS);
    var soapAction = 'http://tempuri.org/GetArrvPaths';
    return invokeWebService(request, headers, soapAction);
}
...
function invokeWebService(body, headers, soapAction){
    var input = {
        ...
        path : '/services/domesticflightsservice.asmx',
        body: {
